  ...
  <div className="w-full overflow-hidden">
    ...
    <div className="flex flex-col items-center mt-8 max-w-md mx-auto w-full bg-white p-6 rounded-lg shadow-md">
      <form>
        ...
        <button
          type="submit"
          className="bg-[#9091DC] text-white py-2 px-4 rounded-lg font-semibold w-full mb-4"
        >
          Login
        </button>
        <div className="flex flex-col gap-2">
          <button
            type="button"
            className="text-[#9091DC] border border-[#9091DC] py-2 px-4 rounded-lg font-semibold w-full mb-2 hover:bg-[#9091DC] hover:text-white transition duration-300"
          >
            Sign Up
          </button>
          <button
